...
def into_put():
    ...
    def info():
        ...
        def insert():
            ...
            if list1 == ["", "", "", ""]:
            ...
            elif list1 == [list1[0],list1[1],"",list1[3]]:
                list01=[list1[0],list1[1],list1[3]]
                ...
                if list01[2] in f:
                    ...
                    mess.showinfo("ERROR status", "duplicate entry")

                else:
                    query = "insert into parking_span(customer_name,customer_phone1,Vehicle_no) VALUES (%s,%s,%s)"
                    cur.execute(query, list01)
    ...
    def entered():
        ...
        def enteredtab():
            ...
            if list2 == ["", "", ""]:
                ...
                elif list2[0] not in f:
                    mess.showinfo("ERROR", "First enter the details")
                    entered()
                else:
    ...
    def showplay():
        ...
        query = "select p1.vehicle_no, p.customer_name, p.customer_phone1, p.customer_phone2 , p1.slot , p1.datetime_entry, p2.datetime_exit from parking_span p right outer join parking_span1 p1 on p.vehicle_no = p1.vehicle_no right outer join parking_span2 p2 on p1.vehicle_no = p2.vehicle_no order by p1.datetime_entry"
        cur.execute(query)
